...
package net.royaltechnica.launcher.creator.util;
...
import net.fasterxml.jackson.core.JsonParseException;
import net.fasterxml.jackson.core.type.TypeReference;
import net.fasterxml.jackson.databind.JsonMappingException;
